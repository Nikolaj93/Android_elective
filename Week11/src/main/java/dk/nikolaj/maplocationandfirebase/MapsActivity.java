...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    LocationManager manager; // handle the permission
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createListener();
        //handle permissions
        //check first if we already have the permission
    ...
    private void handlePermissionUpdate() {
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED){
            ...
            manager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 1000, 0, listener); // start listening to updates.. 1000 = 1 sec, 0 = updates all the time
        }
    }
    ...
    private void moveCamera(double latitude, double longitude) {
        ...
        mMap.clear();
        mMap.addMarker(new MarkerOptions().position(sydney).title("Marker in Copenhagen"));
